...
<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
  <thead>
		<tr>
			<th>Cedula<i class="fa fa-sort"></i></th>
			<th>Tipo Ced.</th>
	...
	<tbody>
		<?php
                ...
                $sql = "SELECT Cedula,TipoCedula,Nombre,Direccion,Zona,Telefono, Concat(Email1,' | ',Email2) as Email FROM Cliente WHERE FK_Usuario=".$_SESSION['IDUsuario']." and Cedula NOT IN('000000000')";                     
...
{
    var dgvVerClientes = document.getElementById('dtBasicExample');

    sessionStorage.setItem("CedulaCliente",dgvVerClientes.rows[oButton.parentNode.parentNode.rowIndex].cells[0].innerHTML);
    sessionStorage.setItem("Modificar",'Modificar');

    location.href ="FormularioAMCliente.php";
}   
</script>
