...
<div class="container">
            <div class="row">
                <div class="col-md-12">
                    <fieldset class="group-border" id="fsEncabezado" style="background-color:white; /*display: none;*/">
                        <legend id="Leyenda" class="group-border">Factura</legend>
						<div class="row">
							<div class="col-lg-1">
							        <label class="control-label" for="NumDoc">Tipo de Documento<span style="font-size: 150%;  color: red;">*</span></label>
						</div>	
							<div class="col-lg-3">
							 ...
							 <div class="col-lg-1">
							        <label class="control-label" for="NumDoc">Actividad Económica<span style="font-size: 150%;  color: red;">*</span></label>
						</div>	
							<div class="col-lg-4">
							      
							        <select class="form-control" id="AE" name="cbmAE" readonly required> 
									<?php
	                                  ...
	                                  $sql = "SELECT AE.Codigo,AE.Nombre,AEXU.Predominante 
												...
												WHERE AEXU.FK_Usuario=".$_SESSION['IDUsuario']." ORDER BY AEXU.Predominante DESC";           
	                                  $result = $Conexion->query($sql);
	                                ?>
	                                <?php while($ri =  mysqli_fetch_array($result))
	                                      {
	                                      	if($ri['Predominante']=='1')
	                                      	{
												echo "<option selected='selected' value=".$ri['Codigo'].">".$ri['Codigo']." | ".$ri['Nombre']."</option>";
											}
											else
											{
												echo "<option value=".$ri['Codigo'].">".$ri['Codigo']." | ".$ri['Nombre']."</option>";
											}
	                                      }
                                	?>
									</select>      
						...
						<div class="col-lg-1">
                        	...
                        	<div class="col-lg-3">
                                    <input class="form-control input-sm" id="Cedula" name="txtCedula" placeholder="Cédula" maxlength="20" value="" type="text">
                            </div>
                            <div class="col-lg-1">
                            ...
                            <div class="col-lg-2">
                                    <input class="form-control input-sm" readonly id="Telefono" name="txtTelefono" placeholder="Teléfono" value="" type="text">
                            </div>
                        </div>
                        <br>
                        <div class="row">
						<div class="col-lg-1">
                        	...
                        	<div class="col-lg-3">
                                    <input class="form-control input-sm" readonly id="Email" name="txtEmail" placeholder="Email" value="" type="text">
                            </div>
                            <div class="col-lg-1">
                                <label class="control-label" for="Name">Dirección</label>
                            </div>
                            <div class="col-lg-4">
                                <input class="form-control input-sm" readonly id="Direccion" name="txtDireccion" placeholder="Dirección" value="" type="text">
                            </div>
							<div class="col-lg-1">
                        ...
                        <div class="row">
                        	<div class="col-lg-1">
                                <label class="control-label" for="Name">Condición de Venta<span style="font-size: 150%;  color: red;">*</span></label>
                            </div>
                            <div class="col-lg-3">
							...
							<div class="col-lg-2">
                                <label class="control-label" for="Name">Plazo<span style="font-size: 150%;  color: red;">*</span></label>
                            </div>
                            <div class="col-lg-3">
									...
									<label class="control-label" id="FechaVencimiento" for="Name">Fecha Vencimiento:</label>
                            </div>
							<div class="col-lg-2">
                                <label class="control-label" for="Name">Medio de Pago<span style="font-size: 150%;  color: red;">*</span></label>
                            </div>
                            <div class="col-lg-3">
  ...
  <input style="display: none;" type="checkbox" id="cbRecaudado" name="Recaudadoporterceros" value="05"><!--Recaudado por terceros.<br>-->
                        ...
                        <div class="row">
						<div class="col-lg-1">
                                <label class="control-label" for="Name">Tipo de Moneda<span style="font-size: 150%;  color: red;">*</span></label>
                            </div>
                            <div class="col-lg-3">
							...
							<div class="col-lg-2">
                                <label class="control-label" for="Name">Tipo de Cambio<span style="font-size: 150%;  color: red;">*</span></label>
                            </div>
							<div class="col-lg-2">
                            ...
                            <div class="col-lg-1">
							      <div class="form-group">
							        <input class="form-control input-sm" id="Terminal" name="txtTerminal" placeholder="Term." type="text" value="" readonly>
							        <label class="control-label" for="NumDoc">Terminal</label>
							      </div>
							 </div>
                            <div class="col-lg-1">
							      <div class="form-group">
							        <input class="form-control input-sm" id="Sucursal" name="txtSucursal" placeholder="Suc." type="text" value="" readonly>
                        ...
                        <div id="AdvNota" style="display: none" class="col-lg-6">
                        ...
                        <div id="AdvFacTiq" style="display: none" class="col-lg-6">
              ...
              <div class="col-lg-2">
                    <div class="form-group">
                      <label class="control-label" for="NumDoc">Pr.Unitario sin IVA.</label>
              ...
              <div class="col-lg-1">
                    <div class="form-group">
                      <label class="control-label" for="NumDoc">IVA</label>
                      <input class="form-control input-sm" id="IVNota" name="txtImpuesto" placeholder="IVA" type="text" value="" readonly>
                    </div>
              </div>
              ...
              <div id="DIVAgregarProducto">
							 <div class="col-lg-2">
							      <div class="form-group">
							        <label class="control-label" for="NumDoc">Cod.Prod</label>
							        <input class="form-control input-sm" id="IDProducto" maxlength="18" name="txtIDProducto" placeholder="Cód. Producto" type="text" value="">
							      </div>
							 </div>
							<div class="col-lg-1">
							      <div class="form-group">
							...
							<div class="col-lg-2">
							      <div class="form-group">
							        <label class="control-label" for="NumDoc">Descripción</label>
							        <input class="form-control input-sm" id="NombreProducto" name="txtDescripcion" placeholder="Producto" type="text" value="" readonly>
							      </div>
							</div>
							<div class="col-lg-2">
							      <div class="form-group">
							...
							<div class="col-lg-1">
							      <div class="form-group">
							        <label class="control-label" for="NumDoc">IVA</label>
							        <input class="form-control input-sm" id="IV" name="txtImpuesto" placeholder="IVA" type="text" value="" readonly>
							      </div>
							</div>
							<div class="col-lg-1">
							      <div class="form-group">
							...
							<div class="pull-right">
								 ...
								 <input type="hidden" id="PrecioCosto" name="txtPrecioCompra" value="">
                 				 ...
                 				 <input type="hidden" id="ImpDev" name="txtImpDev" readonly value="">
                 				 <input type="hidden" id="SExoL" name="txtSExoL" readonly value="">
                 				 <input type="hidden" id="ExoL" name="txtExoL" readonly value="">
								<div>
							...
							<div class="row">
								<div class="pull-right">
								      <div class="form-inline" >
								        <label class="control-label" for="NumDoc">Servicio Exonerado</label>
								        <input class="form-control input-sm" style="font-size:15px;" id="MontoSExoF" name="txtMontoSExoF" placeholder="MontoSExo" type="text" value="0.00" readonly>
								      </div>
								</div>
							</div>
							...
							<div class="row">
								<div class="pull-right">
								      <div class="form-inline" >
								        <label class="control-label" for="NumDoc">Monto Exonerado</label>
								        <input class="form-control input-sm" style="font-size:15px;" id="ExoneradoF" name="txt
								        exoneradoF" placeholder="Exonerado" type="text" value="0.00" readonly>
								      </div>
								</div>
							</div>
							...
							<div class="row">
								<div class="pull-right">
								      <div class="form-inline" >
								        <label class="control-label" for="NumDoc">IVA</label>
								        <input class="form-control input-sm" style="font-size:15px;" id="ImpuestoVentasF" name="txtImpuestoVentasF" placeholder="IVA" type="text" value="0.00" readonly>
								      </div>
								</div>
							</div>
							...
							<div class="row">
								<div class="pull-right">
								      <div class="form-inline" >
								        <label class="control-label" for="NumDoc">IVA Devuelto</label>
								        <input class="form-control input-sm" style="font-size:15px;" id="ImpuestoVentasDevueltoF" name="txtImpuestoVentasDevueltoF" placeholder="IVA Devuelto" type="text" value="0.00" readonly>
								      </div>
								</div>
							</div>
              ...
              <div id="BotonesNota" style="display: none; " class="row">
                <div class="col-lg-2">
                  ...
                  <th data-column-id="NoLinea">No. Linea</th>
									...
									<th style="text-wrap:normal;word-wrap:break-word" data-column-id="NombreProducto">Producto</th>
                            ...
                            <th data-column-id="MontoSExonerado" style="display: none;">Cant. Devuelta</th>
                            <th data-column-id="MontoExonerado" style="display: none;">Cant. Devuelta</th>
                            <th data-column-id="MontoIVDevuelto" style="display: none;">Cant. Devuelta</th>
								</tr>
							</thead>
						</table>
				    </div>
	                ...
	                $( '#IDProducto' ).autocomplete({
	                    ...
	                    select: function (event, ui) {
	                        ...
	                        $.ajax({
	                            url: 'Logica/getDetailsProducto.php',
	                            type: 'post',
	                            data: {IDp:idp,TipoCambio:TipoCambio,request:2},
	                            dataType: 'json',
	                            success:function(response){
	                                ...
	                                if(len > 0){
										...
										$('#CantDisp').prop('readonly',true);
										
										$("#TipoMoneda").prop('disabled', true);
			  							$("#TipoCambio").attr("readonly","readonly");
...
function allEqual(input) {
  ...
  var PrecVent=document.getElementById('PrecioVenta').value;
  var PrecioVentaSinPunto=PrecVent.replace('.','');
  ...
  if(document.getElementById('IDProducto').value=="")
  {
      ...
      $("#ModalMSJ").modal("show");
  		  ...
  		  CantidadIngresadaSinPunto=="NaN"||CantidadIngresada=="NaN" ||CantidadIngresada=='NaN')
  {
	  $("#MSJ").html("Error: Digite la cantidad de producto");
	  $("#ModalMSJ").modal("show");
  }
  /*else if(CantidadDisponible==0 && IDProdAIngresar!='000000000000000000') 
  {
  ...
  /*else if((UnidadMedida=='sp'&&parseFloat(CantidadIngresada)>CantidadDisponible)||
  		  (UnidadMedida!='sp'&&((parseFloat(CantidadIngresada)+CantidadEnDetalle)>CantidadDisponible)))
  {
      $("#MSJ").html("Error: La cantidad de producto ingresada en la factura es mayor a la cantidad disponible");
      $("#ModalMSJ").modal("show");
  }*/
  else if(IDProdAIngresar!='000000000000000000' && (allEqual(CantidadIngresadaSinPunto)) && CantidadIngresadaSinPunto.indexOf('0') > -1)
  {
  ...
  else if((allEqual(PrecioVentaSinPunto) && PrecioVentaSinPunto.indexOf('0') > -1)  && IDProdAIngresar!='000000000000000000')
  {
  ...
  {
      $("#MSJ").html("Error: El campo del descuento no puede estar vacío, Debe ingresar un porcentaje de descuento");
      $("#ModalMSJ").modal("show");
  }
  else if(parseFloat(document.getElementById('Descuento').value)>100)
  {
      $("#MSJ").html("Error: El descuento no puede ser mayor al 100%");
      $("#ModalMSJ").modal("show");
  }
  else if(IDProdAIngresar=='000000000000000000'&&(CantLineasEnDetalle-1)==0)
  {
  	  $("#MSJ").html("Error: La factura debe contener al menos una línea de producto en el detalle antes de ingresar un comentario");
      $("#ModalMSJ").modal("show");
  }
  else if(document.getElementById('TipoCambio').value=="0" || document.getElementById('TipoCambio').value=="")
	{
	  $("#MSJ").html("Error: El tipo de cambio no puede ser 0 o no puede estar en blanco");
	  $("#ModalMSJ").modal("show");
	}
	else if(parseFloat(document.getElementById('TipoCambio').value)<550 && document.getElementById('TipoMoneda').value=="D")
	{
	  $("#MSJ").html("Error: El tipo de cambio no puede ser menor a 550 cuando la factura es en dólares");
	  $("#ModalMSJ").modal("show");
	}
	else if(parseFloat(document.getElementById('TipoCambio').value)<600 && document.getElementById('TipoMoneda').value=="E")
	{
	  $("#MSJ").html("Error: El tipo de cambio no puede ser menor a 600 cuando la factura es en euros");
	  $("#ModalMSJ").modal("show");
	}
	else if(document.getElementById('Cedula').value=="")
	{
	  $("#MSJ").html("Error: Debe ingresar el cliente");
	  $("#ModalMSJ").modal("show");
	}
  else
  {
    ...
    if(CantidadDisponible<=0 && IDProdAIngresar!='000000000000000000') 
  	{
      $("#MSJ").html("Error: no hay suficiente cantidad de ese producto en el inventario");
      $("#ModalMSJ").modal("show"); 
  	}
    ...
    $.ajax({
          ...
          data: 
          {
             ...
             ClienteExonerado:document.getElementById('Exonerado').value,
          ...
          success:function(response){
              ...
              if(len > 0){
                /*Traer campos de la tabla para agregarlos*/
                  ...
                  var MontExo=response[0]['MontoExo'];
                  var MontSE=response[0]['MontoSE'];
                  var MontSG=response[0]['MontoSG'];
                  var MontSExo=response[0]['MontoSExo'];
                  var MontIV=response[0]['MontoImpV'];
                  var MontIVD=response[0]['MontoImpVD'];
                  ...
                  var MExoF=response[0]['MontoExoF'];
                  var MSEF=response[0]['MontoSEF'];
                  var MSGF=response[0]['MontoSGF'];
                  var MSExoF=response[0]['MontoSExoF'];
                  var MIVF=response[0]['MontoImpVF'];
                  var MIVDF=response[0]['MontoImpVDF'];
                  ...
                  var MontoSExonerado = a.insertCell(23); 
                  var MontoExonerado = a.insertCell(24);
                  var MontoIVDevuelto = a.insertCell(25);   
                  ...
                  MontoSExonerado.style.display = 'none';          
                  MontoExonerado.style.display = 'none';          
                  MontoIVDevuelto.style.display = 'none';          
...
+ '<span class="glyphicon glyphicon-remove"></span>Borrar</button>';
                  ...
                  MontoSExonerado.innerHTML=MontSExo; 
                  MontoExonerado.innerHTML=MontExo;
                  MontoIVDevuelto.innerHTML=MontIVD;
            ...
            document.getElementById('MontoSExoF').value=MSExoF;
              document.getElementById('ExentoF').value=MEF;
              document.getElementById('GravadoF').value=MGF;
              document.getElementById('ExoneradoF').value=MExoF;
            ...
            document.getElementById('ImpuestoVentasDevueltoF').value=MIVDF;
	...
	function borrarFila(oButton)
	{
		...
		var CantFilasConDetalle=0;
		
		$('#dgvDetalleFactura tr').each(function(row, tr){
				
	        var IDDetalle= $(tr).find('td:eq(20)').text();
		...
		if(document.getElementById('IDFactura').value!="" && //Si la factura no es nueva 
		  ((dgvDetalleFactura.rows.length)==2 ||//y  el detalle de factura solo tiene 1 linea
		  (CantFilasConDetalle==1)&&IDDF!=''))//y el detalle de fatura tiene id
		{
		...
		else //borrar fila
		{
			...
			if(IDDF=='')/*no tiene id detalle factura, es una linea nueva=> solo borrar*/
			{
				$.ajax({
		            ...
		            data: 
		            {
		               ...
		               MExoT:dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[24].innerHTML,
		               ...
		               MSExoT:dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[23].innerHTML,
		               MIVT:dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[12].innerHTML,
		               MIVDT:dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[25].innerHTML,
			...
			else /*Tiene id detalle factura, es una factura existente*/
			{
				...
				sessionStorage.setItem("MExoT",dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[24].innerHTML);
				...
				sessionStorage.setItem("MSExoT",dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[23].innerHTML);
				sessionStorage.setItem("MIVT",dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[12].innerHTML);
				sessionStorage.setItem("MIVDT",dgvDetalleFactura.rows[oButton.parentNode.parentNode.rowIndex].cells[25].innerHTML);
	...
	<script>
		...
		function BorrarFilaDetalleFactExist()
		{
			...
			var MExoT= sessionStorage.getItem("MExoT");
			var MSET= sessionStorage.getItem("MSET");
			var MSGT= sessionStorage.getItem("MSGT");
			var MSExoT= sessionStorage.getItem("MSExoT");
			var MIVT= sessionStorage.getItem("MIVT");
			var MIVDT= sessionStorage.getItem("MIVDT");
...
<script>
	...
	function AgregarProductoPNota()
	{
		...
		var ServicioExoneradoL=document.getElementById("SExoL").value;
        var ImpuestoDevueltoL=document.getElementById("ImpDev").value;
        var MontoExoneradoL=document.getElementById("ExoL").value;
		...
		else
		{
          ...
          data: 
          {
             btnAgregarProducto:'AgregarProducto', 
                ...
                ServicioExoneradoL:ServicioExoneradoL,
        		ImpuestoDevueltoL:ImpuestoDevueltoL,
        		MontoExoneradoL:MontoExoneradoL,
          ...
          success:function(response){
              ...
              if(len > 0){
                /*Traer campos de la tabla para agregarlos*/                
                  ...
                  var MontExo=response[0]['MontoExo'];
                  var MontSExo=response[0]['MontoSExo'];
                  var MontIVDev=response[0]['MontoImpVDev'];
                  var SubtL=response[0]['SubtL'];
                  var TotL=response[0]['TotL'];
                  ...
                  var MSExoF=response[0]['MontoSExoF'];
                  var MIVF=response[0]['MontoImpVF'];
                  var MIVDevF=response[0]['MontoImpVDevF'];
                  var MOIVF=response[0]['MontoOImpF'];
                  var MDF=response[0]['MontoDescF'];
                  var MSF=response[0]['SubtF'];
                  var MTF=response[0]['TotF'];  
				  ...
				  for (i = 0; i < tr.length; i++) 
				  {
				    ...
				    if (td) 
				    {
				      ...
				      if (txtValor.indexOf(filtro) > -1) 
				      {
				        ...
				        tr[i].getElementsByTagName("td")[23].innerHTML=MontSExo;//Cant. Devuelta
				        tr[i].getElementsByTagName("td")[24].innerHTML=MontExo;//Cant. Devuelta
				        tr[i].getElementsByTagName("td")[25].innerHTML=MontIVDev;//Cant. Devuelta
            ...
            document.getElementById('MontoSExoF').value=MSExoF;
              ...
              document.getElementById('DescF').value=MDF;
            document.getElementById('ImpuestoVentasF').value=MIVF;
            document.getElementById('ImpuestoVentasDevueltoF').value=MIVDevF;
            document.getElementById('OImpF').value=MOIVF;
              document.getElementById('TotalF').value=MTF;
...
function allEqual(input) {
	...
	{	
		...
		if(TipoDoc=='NotaDebito'||TipoDoc=='NotaCredito')//si es Nota C/D enviar a Nota.php a guardar o modificar
		{
		    ...
		    {
		        $("#MSJ").html("Error: Debe ingresar una cédula");
		        $("#ModalMSJ").modal("show");
		    }
		            ...
		            document.getElementById('Zona').value==""))
		    {
		        $("#MSJ").html("Error: Debe ingresar un cliente");
		        $("#ModalMSJ").modal("show");
		    }
		    ...
		    else
		    {
		    	var TableData = new Array();
		        	...
		        	$('#dgvDetalleFactura tr').each(function(row, tr){
				            ...
				            , "MontoSExonerado" : $(tr).find('td:eq(23)').text()
				            , "MontoExonerado" : $(tr).find('td:eq(24)').text()
				            , "MontoIVDevuelto" : $(tr).find('td:eq(25)').text()
				        	}
			        });
					...
					if(document.getElementById('cbRecaudado').checked)
					{
		       		 ...
		       		 $.ajax({
		                  ...
		                  data: 
		                  {
							 ...
							 EmailCliente:(document.getElementById("Email").value!='')?document.getElementById("Email").value:'NULL',
		                     ...
		                     ActividadEconomica:(document.getElementById("AE").value!='')?document.getElementById("AE").value:'NULL',
		...
		else//es grabar mod factura o tiquete
		{
		    ...
		    else if(document.getElementById('TipoDocumento').value=="Tiquete" && document.getElementById('Nombre').value=="")
		    {
		        $("#MSJ").html("Error: Debe ingresar un cliente");
		        $("#ModalMSJ").modal("show");
		    }
		    ...
		    else
		    {
					...
					var Saldo=(document.getElementById('CondicionVenta').value=='02')?document.getElementById('TotalF').value:'0.00';
  ...
  for (i = 0; i < tr.length; i++) 
  {
    ...
    if (td) 
    {
      ...
      if (txtValor.indexOf(filtro) > -1) 
      {
        ...
        document.getElementById("SExoL").value=tr[i].getElementsByTagName("td")[23].textContent;
        document.getElementById("ImpDev").value=tr[i].getElementsByTagName("td")[25].textContent;
        document.getElementById("ExoL").value=tr[i].getElementsByTagName("td")[24].textContent;
      ...
      else
      {
	    ...
	    document.getElementById("SExoL").value= "";
        document.getElementById("ImpDev").value= "";
        document.getElementById("ExoL").value= "";
	  }
    }    
  }
...
window.onload = function() {
	...
	if(TipoDocAGenerar!=null && (TipoDocAGenerar=='NotaCredito'|| TipoDocAGenerar=='NotaDebito'))//se va a hacer una nota credito o debito
	{
		...
		if(Estatus!="" && NoFactElect!="" && IDFactura!=null && CedulaCliente!=null && Modificar!=null && TipoDocAGenerar=='NotaDebito')//para hacer ND
    	{
	         ...
	         $.ajax({
	            ...
	            if(len > 0){
	                  ...
	                  if(response[0]["ActividadEconomica"]!=null)
	                  {
					  	document.getElementById('AE').value = response[0]['ActividadEconomica'];
	                  ...
	                  document.getElementById('MontoSExoF').value = response[0]['ServicioExonerado'];
	                  document.getElementById('ExoneradoF').value = response[0]['MontoExonerado'];
	                  document.getElementById('ImpuestoVentasDevueltoF').value = response[0]['ImpuestoDevuelto'];
					  ...
					  MontoSExonerado.innerHTML=subArr['MontoServicioExonerado']; 
                  	  MontoExonerado.innerHTML=subArr['MontoExonerado'];
                      MontoIVDevuelto.innerHTML=subArr['MontoImpuestoDevuelto'];
					  });
		  ...
		  if(Plazo!='')
		  {
				  ...
				  var value = $('#Fecha').attr("value").split(new RegExp('[-+()*/:? ]', 'g'))
			    ...
			    if (!isNaN(date.getTime())) {
			      ...
			      d = 
			      {
				  	...
				  	document.getElementById('FechaVencimiento').innerHTML='Fecha Vencimiento: ';
				  	document.getElementById('FechaVencimiento').innerHTML += newDate;
			    }
		  }
		  else
		  {
	  ...
	  function checkTime(i) {
		...
		else if(Estatus!="" && NoFactElect!="" && IDFactura!=null && CedulaCliente!=null && Modificar!=null && TipoDocAGenerar=='NotaCredito')//para hacer NC
    	{
	    	 document.getElementById('IDFactura').value=IDFactura;
	         sessionStorage.clear();
	         ...
	         $.ajax({
	            ...
	            if(len > 0){
	                  ...
	                  document.getElementById('MontoSExoF').value = (CondicionNota!=null && CondicionNota=='Parcial')?'0.00':response[0]['ServicioExonerado'];
	                  ...
	                  document.getElementById('ExoneradoF').value = (CondicionNota!=null && CondicionNota=='Parcial')?'0.00':response[0]['MontoExonerado'];
	                  ...
	                  document.getElementById('ImpuestoVentasDevueltoF').value = (CondicionNota!=null && CondicionNota=='Parcial')?'0.00':response[0]['ImpuestoDevuelto']; 
	...
	{		
		...
		if(Estatus!="" && NoFactElect!="" && IDFactura!=null && CedulaCliente!=null && Modificar!=null)//ver la factura/Nota
    	{
			...
			else
			{
	         ...
	         $.ajax({
	            ...
	            if(len > 0 && ValidarTipoDocumento!=null && (ValidarTipoDocumento=='Tiquete' || ValidarTipoDocumento=='Factura')){// consultar factura/tiquete
	                	/*Cliente*/
		  ...
		  if(Plazo!='')
		  {
		  		// Splits date into array of date components
				  //    [day, month, year, hours, minutes, seconds]
				  var value = response[0]["Fecha"].split(new RegExp('[-+()*/:? ]', 'g'))
	  ...
	  function checkTime(i) {
		  ...
		  return i;
		        	...
		        	else if(len > 0 && ValidarTipoDocumento!=null && (ValidarTipoDocumento!='Tiquete' || ValidarTipoDocumento!='Factura')){//consultar Nota
	    ...
	    else if(Estatus=="" && NoFactElect=="" && IDFactura!=null && CedulaCliente!=null && Modificar!=null)//modificar factura o tiquete o nota
	    {
			...
			else
			{
	         ...
	         $.ajax({
	            ...
	            if(len > 0 && ValidarTipoDocumento!=null && (ValidarTipoDocumento=='Tiquete' || ValidarTipoDocumento=='Factura')){// modificar factura tiquete
	                	/*Cliente*/
	                  document.getElementById('IDFactura').value = response[0]['IDFactura'];
	                  document.getElementById('Cedula').value = response[0]['FK_Cliente']; 
	                  document.getElementById('Nombre').value = response[0]['NombreCliente'];
	...
	+ '<span class="glyphicon glyphicon-remove"></span>Borrar</button>';
	  ...
	  function checkTime(i) {
		  ...
		  return i;
		        	...
		        	else if(len > 0 && ValidarTipoDocumento!=null && (ValidarTipoDocumento!='Tiquete' || ValidarTipoDocumento!='Factura')){// modificar nota
	         /*Cliente*/
	                  document.getElementById('IDFactura').value = response[0]['IDNota'];
	                  document.getElementById('Cedula').value = response[0]['FK_Cliente']; 
	                  document.getElementById('Nombre').value = response[0]['NombreCliente'];
	  ...
	  function checkTime(i) {
	    ...
	    else //para hacer una nueva factura o tiquete
	    {
	    	$("#AdvFacTiq").show();
	    	$.ajax({
	              url: 'Logica/Factura.php',
	              ...
	              success:function(response){
					...
					$("#TipoDocumento option:contains('Nota Débito')").attr("disabled","disabled");
					$("#TipoDocumento option:contains('Nota Crédito')").attr("disabled","disabled");
	...
	$('#TipoDocumento').on('change', function () {
      ...
      var leyenda=$("#Leyenda");
		  ...
		  // lowercase comparison for case-insensitivity
 			...
 			document.getElementById('CondicionVenta').value="01";
			...
			for (var i = 0; i < op.length; i++) {
 			...
 			$("#Cedula").prop("readonly", true);
 			$("#CondicionVenta").prop("disabled", true);
...
$('#NombreProducto').on('input',function(e){
	
    if(document.getElementById('NombreProducto').value!='')
    {
		document.getElementById('IDProducto').value='000000000000000000';
		$("#IDProducto").prop("readonly", true);
		
		document.getElementById('Cantidad').value='0.00';
		$("#Cantidad").prop("readonly", true);
		
		document.getElementById('PrecioVenta').value='0.00';
		$("#PrecioVenta").prop("readonly", true);
		
		document.getElementById('Descuento').value='0.00';		
		$("#Descuento").prop("readonly", true);
		
		document.getElementById('IV').value='0.00';
		document.getElementById('CantDisp').value='0.00';
...
<script>
  $("#IDProducto").focus(function(){
    	if(document.getElementById('TipoCambio').value=="0" || document.getElementById('TipoCambio').value=="")
		{
			document.getElementById('IDProducto').value="";
			document.getElementById('PrecioVenta').value="";
		   	document.getElementById('IV').value="";
...
$("#NombreProducto").focus(function () {
    if(document.getElementById('IDProducto').value=='000000000000000000')
    {
...
$("#NombreProducto").focusout(function () {
    if(document.getElementById('IDProducto').value=='' && document.getElementById('NombreProducto').value=='')
    {
		$('#NombreProducto').prop('readonly', true);	
	}
	else
...
<?php
	function ObtenerFecha($Fecha,$DiasAAgregar)
	{
		date_default_timezone_set("America/Costa_Rica");
