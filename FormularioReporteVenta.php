            ...
            <div class="row">
                <div class="col-md-12">
                    <fieldset class="group-border" style="background-color:white; /*display: none;*/">
                        <legend id="Leyenda" class="group-border">Reportes de Venta</legend>
                        ...
                        <div style="margin: auto; width: 100%;" class="row">
                        	...
                        	<legend id="Leyenda" class="group-border">Cliente</legend>
	                            <div class="col-lg-2">
                        ...
                        <div style="margin: auto; width: 100%;" class="row">
                        	<div class="col-lg-1">
                                <button type="button" onclick="ReportarVenta()" style="display:inline-block; border: none; background: none;"><a title="Exportar a Excel" data-toggle="tooltip"><i class="fa fa-file-excel-o" style="font-size:48px; color:#1f7244;"></i></a><figcaption> Exportar </figcaption></button>
                            </div>
...
function ReportarVenta(){
  ...
  {
  	    var btnGenerarReporteVentas="GenerarReporteVentas";
