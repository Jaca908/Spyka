...
<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
  <thead>
		<tr>
			...
			<th style="width: 500px">Producto<i class="fa fa-sort"></i></th>
            <th style="display:none;">FK_Grupo</th>
			<th>Grupo</th>
			<th>Acciones</th>
		</tr>
	</thead>
	<tbody>
		<?php
                ...
                $sql = "SELECT P.IDProducto,P.NombreProducto,P.FK_Grupo,G.Grupo 
						FROM Producto P 
						inner join Grupo G on P.FK_Grupo=G.IDGrupo AND P.FK_Usuario = G.FK_Usuario 
						WHERE IDProducto NOT IN('000000000000000000') AND P.FK_Usuario=".$_SESSION['IDUsuario']."";                     
        ...
        ?>
                <?php while($ri =  mysqli_fetch_array($result))
                      ...
                      echo "<tr>";
                        ...
                        echo '<td style="display:none;">'.$ri['FK_Grupo'].'</td>';
                        echo "<td>".$ri['Grupo']."</td>";
                       echo "<td>";
...
{
    var dgvVerProductos = document.getElementById('dtBasicExample');

    sessionStorage.setItem("CodigoProducto",dgvVerProductos.rows[oButton.parentNode.parentNode.rowIndex].cells[0].innerHTML);
    sessionStorage.setItem("Modificar",'Modificar');

    location.href ="FormularioAMProducto.php";
}   
</script>
